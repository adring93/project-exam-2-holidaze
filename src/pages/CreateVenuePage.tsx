...
function CreateVenuePage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(
        error instanceof Error ? error.message : 'Could not create venue',
      )
    } finally {
      setIsLoading(false)
    }
    ...
    <section className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="mt-8">
        ...
        <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">
          Create a new Holidaze venue.
        </h1>
        <p className="mt-5 text-lg leading-8 text-slate-600">
          Add the key information customers need before booking your venue.
        </p>
      </div>
        ...
        <div className="grid gap-5">
          <div>
            ...
            <input
              ...
              placeholder="Mountain cabin with fjord view"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-slate-950"
              placeholder="Cabin exterior with fjord view"
            />
          </div>
